...
async def start(event):
  await event.reply("**Ben Tagger Bot**, Grup veya kanaldaki neredeyse tüm üyelerden bahsedebilirim ★\nDaha fazla bilgi için **/help**'i tıklayın.",
                    buttons=(
                      [Button.url('🌟 Beni Bir Gruba Ekle', 'https://t.me/tg_tagbot?startgroup=a'),
                      Button.url('📣 Geliştirici', 'https://t.me/sessizkatillersohbet')]
                    ),
                    link_preview=False
                   )
...
async def help(event):
  ...
  await event.reply(helptext,
                    buttons=(
                      [Button.url('🌟 Beni Bir Gruba Ekle', 'https://t.me/tg_tagbot?startgroup=a'),
                      Button.url('📣 Geliştirici', 'https://t.me/suskunlarasistan')]
                    ),
                    link_preview=False
                   )
